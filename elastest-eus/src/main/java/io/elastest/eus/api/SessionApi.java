...
public interface SessionApi {
    ...
    @ApiOperation(value = "Remove a subscription", notes = "", response = Void.class, tags={ "event subscription", })
    @ApiResponses(value = { 
...
@ApiParam(value = "Subscription identifier (previously subscribed)",required=true ) @PathVariable("subscriptionId") String subscriptionId
    ...
    @ApiOperation(value = "Read the audio level of a given element (audio|video tag)", notes = "", response = AudioLevel.class, tags={ "basic media evaluation", })
    @ApiResponses(value = { 
...
@ApiParam(value = "Element identifier (previously located)",required=true ) @PathVariable("elementId") String elementId
    ...
    @ApiOperation(value = "Read the RGB color of the coordinates of a given element", notes = "", response = ColorValue.class, tags={ "basic media evaluation", })
    @ApiResponses(value = { 
...
,@ApiParam(value = "Coordinate in y-axis", defaultValue = "0") @RequestParam(value = "y", required = false, defaultValue="0") Integer y
    ...
    @ApiOperation(value = "Read the value of event for a given subscription", notes = "", response = EventValue.class, tags={ "event subscription", })
    @ApiResponses(value = { 
...
@ApiParam(value = "Subscription identifier (previously subscribed)",required=true ) @PathVariable("subscriptionId") String subscriptionId
    ...
    @ApiOperation(value = "Read the WebRTC stats", notes = "", response = StatsValue.class, responseContainer = "List", tags={ "WebRTC stats", })
    @ApiResponses(value = { 
...
,@ApiParam(value = "Identifier of peerconnection") @RequestParam(value = "peerconnectionId", required = false) String peerconnectionId
    ...
    @ApiOperation(value = "Set user media for WebRTC", notes = "", response = Void.class, tags={ "user media", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful operation", response = Void.class),
...
@ApiParam(value = "Media URL to take WebRTC user media" ,required=true ) @RequestBody UserMedia body
    ...
    @ApiOperation(value = "Measure end-to-end latency of a WebRTC session", notes = "The E2E latency calculation is done comparing the media in P2P WebRTC communication (presenter-viewer)", response = EventSubscription.class, tags={ "advance media evaluation", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/session/{sessionId}/element/{elementId}/latency",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
...
@ApiParam(value = "Definition of WebRTC producer (presenter) and sample rate (in ms)" ,required=true ) @RequestBody Latency body
    ...
    @ApiOperation(value = "Measure quality (audio|video) of a WebRTC session", notes = "The quality indicator is calculated comparing the media in P2P WebRTC communication (presenter-viewer)", response = EventSubscription.class, tags={ "advance media evaluation", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful operation", response = EventSubscription.class),
        @ApiResponse(code = 400, message = "Invalid session identifier", response = EventSubscription.class),
        @ApiResponse(code = 404, message = "No such element", response = EventSubscription.class) })
    @RequestMapping(value = "/session/{sessionId}/element/{elementId}/quality",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
...
@ApiParam(value = "Definition of WebRTC producer (presenter), selection of QoE algorithm, and sample rate (in ms)" ,required=true ) @RequestBody Quality body
    ...
    @ApiOperation(value = "Subscribe to a given event within an element", notes = "", response = EventSubscription.class, tags={ "event subscription", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful operation", response = EventSubscription.class),
        @ApiResponse(code = 400, message = "Invalid session identifier", response = EventSubscription.class),
        @ApiResponse(code = 403, message = "Forbidden", response = EventSubscription.class),
        @ApiResponse(code = 404, message = "No such element", response = EventSubscription.class) })
    @RequestMapping(value = "/session/{sessionId}/element/{elementId}/event",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)

...
Add-Content c:\selenium.bat "`njava -Dwebdriver.edge.driver=`"C:\tools\selenium\MicrosoftWebDriver.exe`" -Dwebdriver.ie.driver=`"C:\tools\selenium\IEDriverServer.exe`" -jar C:\Users\IEUser\selenium-server-standalone.jar -host HOST_IP -hub http://HOST_IP:4444 -port 5556 -role node"
